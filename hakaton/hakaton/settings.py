...
SECRET_KEY = 'django-insecure-%wl@$-l-8g=w)*#@gmtl=462w-l70-os$^#rd_2(v$layt))w+'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'plplpl',           # имя вашей БД
        'USER': 'myuser',         # пользователь (не postgres, если создавали своего)
        'PASSWORD': '123123123',  # пароль
        'HOST': 'localhost',      # или '127.0.0.1'
        'PORT': '5434',           # стандартный порт
    }
}
